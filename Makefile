#############################################################################
# Makefile for building: C++2048
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  C++2048.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile C++2048.pro
#############################################################################
...
Makefile: C++2048.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/C++20481.0.0 || mkdir -p .tmp/C++20481.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/C++20481.0.0/ && $(COPY_FILE) --parents mainwindow.h data.h .tmp/C++20481.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp data.cpp .tmp/C++20481.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/C++20481.0.0/ && (cd `dirname .tmp/C++20481.0.0` && $(TAR) C++20481.0.0.tar C++20481.0.0 && $(COMPRESS) C++20481.0.0.tar) && $(MOVE) `dirname .tmp/C++20481.0.0`/C++20481.0.0.tar.gz . && $(DEL_FILE) -r .tmp/C++20481.0.0
